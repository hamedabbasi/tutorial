package com.tutorial.samples.serializable;
...
public class TestSerializable implements Serializable {
     ...
     * sender's class, then deserialization will result in an InvalidClassException. A
     * serializable class can declare its own serialVersionUID explicitly by declaring a
